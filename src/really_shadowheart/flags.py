...
Shadowheart_ReadyForUltimatum = bg3.flag_object(
    files, 'Shadowheart_ReadyForUltimatum', bg3.GLOBAL_FLAG, flag_uuid='12040db6-f300-4b55-84bf-09e328a64df4', description='All condition for Shadowheart Ultimatum scene have been met.')
